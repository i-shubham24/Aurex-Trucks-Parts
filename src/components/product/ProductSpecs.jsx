                  ...
                  {product.specs.map((spec, index) => {
                    ...
                    return (
                      <li key={index} className="rounded-xl bg-[#F7F8FA] border border-[#E5E7EB] p-4 flex gap-3 items-start">
                        ...
                        <span className="text-[#1A1A2E] font-medium">{spec}</span>
                      </li>
                    );
                  })}
                </ul>
                  ...
                  {product?.oem && (
                    <div className="mt-4 bg-[#10B981]/10 border border-[#10B981]/20 rounded-xl p-4">
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          <p className="text-[#1A1A2E] font-semibold">OEM Cross Reference</p>
            ...
            <div>
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-[#1A1A2E] font-semibold mb-1">Free Shipping</p>
                    <p className="text-sm">
