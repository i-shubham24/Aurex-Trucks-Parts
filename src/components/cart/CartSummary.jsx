    ...
    return (
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="font-display font-bold text-xl text-[#1A1A2E]">${total.toFixed(2)}</p>
        </div>
        {showCheckout && (
          <Link
            to="/checkout"
    ...
    <div className="space-y-4">
      ...
      <div className="space-y-3">
        <div className="flex justify-between text-sm">
          ...
          <span className="font-semibold text-[#1A1A2E]">${total.toFixed(2)}</span>
        </div>
        <div className="flex justify-between text-sm">
        ...
        <div className="border-t border-[#E5E7EB] pt-3">
          <div className="flex justify-between">
            ...
            <span className="font-display font-bold text-2xl text-[#1A1A2E]">${total.toFixed(2)}</span>
          </div>
        </div>
      </div>
