  ...
  return (
    <div className="grid lg:grid-cols-2 gap-5 items-start">
      <div>
        ...
        <div className="mt-4 rounded-[22px] border border-white/10 bg-[#0d1218] p-5 grid sm:grid-cols-[1fr_120px_auto] gap-2.5">
          ...
          <button onClick={() => { if (!code.trim()) return; setPromos([{ code: code.trim(), label: "Custom", pct, active: true }, ...promos]); setCode(""); }} className="rounded-xl bg-[#ff4d00] px-5 py-3 text-sm font-black">Add</button>
        </div>
        <div className="mt-4 space-y-2.5">{promos.map((p) => (
          <div key={p.code} className="flex items-center gap-3 rounded-2xl border border-white/10 bg-[#0d1218] p-4">
      ...
      <div>
        ...
        <div className="mt-4 rounded-[22px] border border-white/10 bg-[#0d1218] p-5 grid gap-3 text-sm">
