      ...
      <div className="max-w-3xl mx-auto px-4 mt-12">
        <div className="bg-white p-8 md:p-12 rounded-3xl shadow-sm border border-[#E5E7EB] flex flex-col md:flex-row items-center gap-8">
          <div className="w-48 h-64 bg-[#F3F4F6] rounded-xl flex items-center justify-center border border-[#E5E7EB] flex-shrink-0 shadow-inner relative overflow-hidden">
             <div className="absolute top-0 left-0 w-full h-1/2 bg-[#134E8D]/10"></div>
             <div className="z-10 flex flex-col items-center">
                <FileText size={48} className="text-[#134E8D] mb-2" />
                <span className="font-display font-black text-[#222538] text-xl">AUREX</span>
                <span className="text-xs font-bold text-[#6B7280] tracking-widest mt-1">CATALOGUE 2026</span>
             </div>
          </div>
          
          <div className="flex-1 text-center md:text-left">
            <h2 className="font-display font-bold text-2xl text-[#222538]">2026 Parts & Accessories Catalogue</h2>
            ...
            <div className="flex flex-wrap gap-4 justify-center md:justify-start mt-6">
              <Link to="/shop" className="bg-[#134E8D] text-white px-6 py-3.5 rounded-xl font-bold text-sm flex items-center gap-2 hover:bg-[#222538] transition">
                Browse the live catalogue <ArrowRight size={16} />
              </Link>
              <Link to="/contact" className="border border-[#E5E7EB] px-6 py-3.5 rounded-xl font-bold text-sm flex items-center gap-2 hover:border-[#134E8D] transition">
