...
export default function Shop({ preset }) {
  ...
  const sel = "rounded-md border border-line-dark bg-white px-2.5 py-2 text-[13px] font-semibold outline-none focus:border-gold";
  ...
  return (
    <main className="mx-auto max-w-7xl px-4 py-6">
      ...
      <div className="mt-3 flex flex-wrap items-center gap-2 rounded-md border border-line bg-mist p-3">
        <span className="flex flex-1 items-center gap-2 rounded-md border border-line-dark bg-white px-3 py-2 sm:max-w-xs">
        ...
        <span className="ml-auto font-mono text-[11px] text-faint">{items.length} LINES</span>
      </div>
