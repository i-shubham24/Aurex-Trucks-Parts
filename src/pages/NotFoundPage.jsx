  ...
  return (
    <div className="min-h-[60vh] grid place-items-center px-4 py-16">
      <div className="text-center max-w-lg">
        <h1 className="font-display font-bold text-[80px] leading-none text-[#1A1A2E]">404</h1>
        <p className="font-display font-bold text-2xl mt-4 text-[#1A1A2E]">Page not found</p>
